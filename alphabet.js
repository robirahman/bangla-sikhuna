...
const CONJUNCTS = [
  ...
  { letter: "ট্ট", name: "Ṭṭo (ṭṭo)", romanized: "ṭṭo", ipa: "ʈʈ", sound: "ট + ট combined", example: "কট্টর (koṭṭor — strict)", type: "conjunct" },
  { letter: "ণ্ড", name: "Ṇḍo (ṇḍo)", romanized: "ṇḍo", ipa: "ɳɖ", sound: "ণ + ড combined", example: "দণ্ড (doṇḍo — punishment)", type: "conjunct" },
  ...
  { letter: "দ্ব", name: "Dwo (dwo)", romanized: "dwo", ipa: "d̪w", sound: "দ + ব combined", example: "দ্বার (dwar — door)", type: "conjunct" },
...
const READING_PASSAGES = [
  ...
  },
  {
    ...
    title: "চায়ের দোকান",
    level: "A1",
    text: "আমাদের বাড়ির কাছে একটি চায়ের দোকান আছে। সেখানে প্রতিদিন অনেক মানুষ আসে। চা, বিস্কুট, আর সিঙ্গারা বিক্রি হয়। দোকানদার কাকু সবাইকে হাসিমুখে চা দেন। আমি প্রতি বিকেলে সেখানে যাই আর বন্ধুদের সাথে গল্প করি। কখনো কখনো বাবাও আসেন। তিনি চা খেতে খেতে খবরের কাগজ পড়েন। চায়ের দোকানটি আমাদের পাড়ার প্রিয় জায়গা।",
    vocabIds: ["আমাদের", "বাড়ি", "চা", "মানুষ", "দোকান", "বন্ধু", "বাবা", "জায়গা"],
    checks: [
      { prompt: "দোকানে কী বিক্রি হয়?", options: ["চা, বিস্কুট, আর সিঙ্গারা", "ভাত আর মাছ", "ফল আর সবজি"], correct: 0 },
      { prompt: "লেখক কখন দোকানে যায়?", options: ["সকালে", "প্রতি বিকেলে", "রাতে"], correct: 1 },
    ],
  },
  {
    id: "school-friend",
    title: "নতুন বন্ধু",
    level: "A2",
    text: "গত সপ্তাহে আমাদের ক্লাসে একজন নতুন ছেলে এসেছে। তার নাম রাফি। সে সিলেট থেকে এসেছে। প্রথম দিনে সে চুপচাপ বসে ছিল। কেউ তার সাথে কথা বলেনি। আমি তার কাছে গিয়ে বললাম, তুমি কি আমার সাথে টিফিন খাবে? সে হেসে বলল, হ্যাঁ! সেই থেকে আমরা বন্ধু। রাফি খুব ভালো ছবি আঁকে। সে আমাকে ছবি আঁকা শেখায়, আর আমি তাকে ক্রিকেট খেলা শেখাই। ভালো বন্ধু পেয়ে আমি খুব খুশি।",
    vocabIds: ["নতুন", "ছেলে", "নাম", "আমি", "বন্ধু", "ভালো", "খুশি", "ক্রিকেট", "আমরা"],
    checks: [
      { prompt: "রাফি কোথা থেকে এসেছে?", options: ["ঢাকা", "চট্টগ্রাম", "সিলেট"], correct: 2 },
      { prompt: "রাফি লেখককে কী শেখায়?", options: ["ক্রিকেট খেলা", "ছবি আঁকা", "গান গাওয়া"], correct: 1 },
    ],
  },
  {
    id: "river-journey",
    title: "নদীর পথে যাত্রা",
    level: "A2",
    text: "গত ছুটিতে আমরা নৌকায় চড়ে নানাবাড়ি গিয়েছিলাম। ভোরে ঘাট থেকে নৌকা ছেড়েছিল। নদীর দুই ধারে সবুজ গাছপালা আর ছোট ছোট গ্রাম দেখা যাচ্ছিল। মাঝি গান গাইছিলেন। নদীতে জেলেরা মাছ ধরছিল। একটি ঘণ্টা পরে আমরা একটি বাজারে থামলাম। মা কিছু মিষ্টি কিনলেন। দুপুরের আগেই নানাবাড়ি পৌঁছে গেলাম। নানা আমাদের দেখে খুব খুশি হলেন। সেদিন নদীর পথের সেই যাত্রা আমার মনে গেঁথে আছে।",
    vocabIds: ["আমরা", "নৌকা", "নদী", "গ্রাম", "মা", "মিষ্টি", "খুশি", "মনে", "গাছ"],
    checks: [
      { prompt: "তারা কীসে চড়ে নানাবাড়ি গিয়েছিল?", options: ["বাসে", "নৌকায়", "রিকশায়"], correct: 1 },
      { prompt: "বাজারে মা কী কিনলেন?", options: ["কাপড়", "মাছ", "মিষ্টি"], correct: 2 },
    ],
  },
  {
    id: "monsoon-memories",
    title: "বর্ষার স্মৃতি",
    level: "B1",
    text: "বর্ষাকাল এলেই ছোটবেলার কথা মনে পড়ে। মা বারান্দায় বসে শীতলপাটিতে আমাদের গল্প শোনাতেন। বৃষ্টি পড়ত ঝমঝম শব্দে। মাঝে মাঝে বিদ্যুৎ চমকাত, তখন ভয়ে মায়ের কোলে লুকিয়ে পড়তাম। বিকেলে বৃষ্টি থামলে রাস্তায় জল জমত। আমরা খালি পায়ে জলে ছুটে বেড়াতাম। মাটির গন্ধ নাকে লাগত। কাদায় পিছলে পড়ে হেসেছি কত বার! বর্ষার সেই দিনগুলো ছিল সরল আনন্দে ভরা। এখন শহরে বৃষ্টি মানে যানজট আর কর্দমাক্ত রাস্তা। তবু প্রতিবার বৃষ্টির শব্দ শুনলে একটুখানি শৈশব ফিরে আসে।",
    vocabIds: ["বর্ষা", "মা", "গল্প", "বৃষ্টি", "রাস্তা", "জল", "শহর", "শব্দ", "আনন্দ", "দিন"],
    checks: [
      { prompt: "বিদ্যুৎ চমকালে লেখক কী করতেন?", options: ["দৌড়াতেন", "মায়ের কোলে লুকাতেন", "জানালা বন্ধ করতেন"], correct: 1 },
      { prompt: "লেখকের কাছে এখন বৃষ্টি মানে কী?", options: ["শৈশবের আনন্দ", "যানজট আর কর্দমাক্ত রাস্তা", "বারান্দায় বসে গল্প"], correct: 1 },
      { prompt: "লেখক শেষে কী বলেন?", options: ["বৃষ্টির শব্দে শৈশব ফিরে আসে", "বর্ষা তার প্রিয় ঋতু নয়", "গ্রামে ফিরে যেতে চান"], correct: 0 },
    ],
  },
  {
    id: "letter-to-grandmother",
    title: "দাদিকে চিঠি",
    level: "B2",
    text: "প্রিয় দাদি, তোমাকে অনেকদিন চিঠি লেখা হয়নি, তাই আজ কলম তুলে নিলাম। শহরে এখন শীতের হাওয়া বইছে। সকালে কুয়াশায় রাস্তা ঢেকে যায়, আর সন্ধ্যায় ঠান্ডা বাতাসে জানালা বন্ধ রাখতে হয়। তোমার রান্না করা পিঠা আর খেজুরের রসের কথা ভাবলে মন চলে যায় গ্রামে। মনে আছে, শীতকালে তুমি ভোরে উঠে চুলায় আগুন জ্বালাতে আর আমরা গরম হাতে পিঠা ভাঙতাম? সেই সোনালি দিনগুলো কত দূরে চলে গেছে! পড়াশোনা ভালো চলছে। এ বছর বিশ্ববিদ্যালয়ের শেষ পরীক্ষা। পরীক্ষার পরে একদিন তোমার কাছে আসব, এটা কথা দিচ্ছি। ততক্ষণ নিজের যত্ন নিও। সবাইকে আমার সালাম জানিও। ভালোবাসা রইল। তোমার নাতি।",
    vocabIds: ["দাদি", "চিঠি", "শহর", "শীত", "সকাল", "রাস্তা", "গ্রাম", "মনে", "পড়াশোনা", "পরীক্ষা", "ভালোবাসা", "দিন"],
    checks: [
      { prompt: "লেখক কোন ঋতু সম্পর্কে লিখছেন?", options: ["গ্রীষ্মকাল", "শীতকাল", "বর্ষাকাল"], correct: 1 },
      {
        prompt: "দাদি ভোরে কী করতেন?",
        options: ["বাগানে যেতেন", "চুলায় আগুন জ্বালাতেন", "নদীতে স্নান করতেন"],
        correct: 1,
      },
      {
        prompt: "লেখক কখন দাদির কাছে যাবেন?",
        options: ["আগামী সপ্তাহে", "পরীক্ষার পরে", "শীত শেষে"],
        correct: 1,
      },
    ],
  },
